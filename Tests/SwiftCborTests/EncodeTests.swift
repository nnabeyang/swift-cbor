...
final class EncodeTests: XCTestCase {
  ...
  func testFloat() throws {
    ...
    XCTAssertEqual(
      try encoder.encode(Double.greatestFiniteMagnitude).hexDescription, "fb7fefffffffffffff")
  ...
  func testArray() {
    ...
    XCTAssertEqual(
      ...
      ]).hexDescription, "98190102030405060708090a0b0c0d0e0f101112131415161718181819")
    XCTAssertEqual(
      try encoder.encode([[1], [2, 3], [4, 5]]).hexDescription, "838101820203820405")
  }
  ...
  func testString() throws {
    ...
    XCTAssertEqual(
      try encoder.encode("こんにちは、世界").hexDescription,
      "7818e38193e38293e381abe381a1e381afe38081e4b896e7958c")
  }

  func testByteString() throws {
    XCTAssertEqual(try encoder.encode(Data(hex: "01020304")).hexDescription, "4401020304")
    XCTAssertEqual(
      try encoder.encode(Data("abcdefghijklmnopqrstuvwxyz".utf8)).hexDescription,
