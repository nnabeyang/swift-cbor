    ...
    default:
      throw DecodingError.typeMismatch(
        ...
        DecodingError.Context(
          codingPath: codingPath,
          debugDescription:
            "Expected to decode \([Any].self) but found \(value.debugDataTypeDescription) instead."
        ))
    }
...
extension _CborDecoder {
  ...
  fileprivate func unbox(_ value: CborValue, as type: Bool.Type) throws -> Bool {
    if case .literal(let value) = value {
  ...
  fileprivate func unbox(_ value: CborValue, as type: String.Type) throws -> String {
    if case .literal(let value) = value {
      try checkNotNull(value, expectedType: type)
      switch value {
      case .str(let v):
  ...
  fileprivate func unboxFloat<T: BinaryFloatingPoint & DataNumber>(
    _ value: CborValue, as type: T.Type
  ) throws -> T {
    if case .literal(let f) = value {
  ...
  fileprivate func unboxInt(_ value: CborValue) throws -> Int {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(Int.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxInt8(_ value: CborValue) throws -> Int8 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(Int8.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxInt16(_ value: CborValue) throws -> Int16 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(Int16.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxInt32(_ value: CborValue) throws -> Int32 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(Int32.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxInt64(_ value: CborValue) throws -> Int64 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(Int64.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxUInt(_ value: CborValue) throws -> UInt {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(UInt.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxUInt8(_ value: CborValue) throws -> UInt8 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(UInt8.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxUInt16(_ value: CborValue) throws -> UInt16 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(UInt16.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxUInt32(_ value: CborValue) throws -> UInt32 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(UInt32.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
  ...
  fileprivate func unboxUInt64(_ value: CborValue) throws -> UInt64 {
    ...
    throw DecodingError.typeMismatch(
      ...
      DecodingError.Context(
        codingPath: codingPath,
        debugDescription:
          "Expected to decode \(UInt64.self) but found \(value.debugDataTypeDescription) instead."
      ))
  }
}
...
extension _CborDecoder {
  ...
  func unwrapData() throws -> Data {
    switch value {
    case .literal(.bin(let v)), .literal(.str(let v)):
      v
    default:
      throw DecodingError.typeMismatch(
        Data.self, DecodingError.Context(codingPath: codingPath, debugDescription: ""))
    }
  }

  func unwrapCborDecodable(as type: CborDecodable.Type) throws -> CborDecodable {
    guard case .tagged(let tagData, let cborValue) = value else {
      throw DecodingError.typeMismatch(
    ...
    guard value.tag == tag else {
      throw DecodingError.dataCorrupted(
        DecodingError.Context(
          codingPath: codingPath,
          debugDescription: "tag number mismatch: expected: \(value.tag) got: \(tag)"))
    }
    return value
  }
    ...
    guard case .map = value else {
      throw DecodingError.typeMismatch(
        ...
        DecodingError.Context(
          codingPath: codingPath,
          debugDescription:
            "Expected to decode \(T.self) but found \(value.debugDataTypeDescription) instead."
        ))
    }
  }
    ...
    guard case .array = value else {
      throw DecodingError.typeMismatch(
        ...
        DecodingError.Context(
          codingPath: codingPath,
          debugDescription:
            "Expected to decode \([CborValue].self) but found \(value.debugDataTypeDescription) instead."
        ))
    }
  }
}
...
private struct CborUnkeyedUnkeyedDecodingContainer: UnkeyedDecodingContainer {
  ...
  private func getNextValue<T>(ofType _: T.Type) throws -> CborValue {
    guard !isAtEnd else {
      let message =
        if T.self == CborUnkeyedUnkeyedDecodingContainer.self {
